...
function generate(count) {
    ...
    var _loop_1 = function (n) {
        var allProps = __spreadArray(__spreadArray([], constants_1.numericProps, true), constants_1.nonNumbericProps, true);
        var newRookie = (0, lodash_1.fromPairs)(allProps.map(function (propName) {
